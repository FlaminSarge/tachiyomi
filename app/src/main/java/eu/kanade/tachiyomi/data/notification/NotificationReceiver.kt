...
class NotificationReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        when (intent.action) {
            ...
            // Pause library update
            ACTION_PAUSE_LIBRARY_UPDATE -> cancelLibraryUpdate(context, Notifications.ID_LIBRARY_PROGRESS)
    ...
    companion object {
        ...
        private const val ACTION_PAUSE_LIBRARY_UPDATE = "$ID.$NAME.PAUSE_LIBRARY_UPDATE"
        ...
        /**
         * Returns [PendingIntent] that starts a service which pauses the library update
         *
         * @param context context of application
         * @return [PendingIntent]
         */
        internal fun pauseLibraryUpdatePendingBroadcast(context: Context): PendingIntent {
            val intent = Intent(context, NotificationReceiver::class.java).apply {
                action = ACTION_PAUSE_LIBRARY_UPDATE
            }
            return PendingIntent.getBroadcast(context, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT)
        }
